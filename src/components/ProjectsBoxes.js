...
import {PopupCrum, PopupMex, PopupFriend, PopupGame, PopupCoffee} from './indexComp';
    ...
    return (
      ...
      (<div className="projectsMain">
        ...
        <div className="project-section">
          ...
          >
            <div className="project-image">
              <img src={friendshopdemo}  className="image" alt="friendShop" />
        ...
        <div className="project-section">
          ...
          >
            <div className="project-image">
              <img src={coffeeClicker} className="image" alt="Coffee Clicker" />
              <div className="project-title">
              <div className="project-category">
