  ...
  <div className="sectionContainerExperience">
    ...
    <div>
      ...
      <br></br>
        ...
        <div className="resume-item">
          ...
          <div className="resume-date">
            ...
            <div className="social-icons">
              <a key='https://www.instagram.com/raddadsofficial/'
              ...
              <a key='https://www.facebook.com/raddadsofficial/'
            ...
            <a key='https://www.raddadsofficial.com'
        ...
        <div className="resume-item">
          <div className="resume-content">
            <div className="title-heading-exp">Sales & Operations Director</div>
          ...
          <div className="date-heading">January 2016 - December 2017</div>
            <div className="social-icons">
              <a key='https://www.mtctransportation.com/'
        ...
        <div className="resume-item">
          <div className="resume-content">
            <div className="title-heading-exp">Sales Intern, Sales Associate</div>
