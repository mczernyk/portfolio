...
import {CarouselDigital} from './indexComp'
      ...
      <div className="design-section-right">
        ...
        <div className="design-text">
          ...
          <div className="design-right">
            <p>I created a series of digital art as a submission for <span className="subheading">Gli.tc/h Festival</span>. I made these images by deliberately corrupting video files, then manipulating playback to generate visual glitches.</p>
          </div>
        </div>
        <br></br>
        <div>
