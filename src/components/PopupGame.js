        ...
        <div className="modal-section">
          <div className="modal-info">
            <h3 className="modal-title">Game Of Life</h3>
              ...
              <ul>
                <li>
                  Core functionality built over a single day as a
                  Fullstack Academy in-class project.
                </li>
                <li>
                ...
                <li>
                  Implemented additional features (randomize board, pause,
                  draw on hover) outside of workshop.
                </li>
              </ul>
          ...
          <div className="modal-date">
            <div>
              ...
              <div className="social-icons-modal">
                <a key='https://mczernyk.github.io/PairProject.Game-of-life/'
