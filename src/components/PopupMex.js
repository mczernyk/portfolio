      ...
      <div className="modal-section">
        <div className="modal-info">
          <h3 className="modal-title">MEXTrix</h3>
            ...
            <ul>
              <li>
                Queries external API feed to track key trading metrics
                on a popular Bitcoin exchange.
              </li>
              <li>
                Orderbook shows live bid/ask spread with volume
                visualization at local price levels.
              </li>
              <li>
                Tracks and displays liquidations and all orders of
                greater than 100k contracts.
              </li>
        ...
        <div className="modal-date">
          <div>
            ...
            <div className="social-icons-modal">
              <a key='https://github.com/mczernyk/Stackathon'
              ...
              <a key='https://stackathon-mc.herokuapp.com/'
