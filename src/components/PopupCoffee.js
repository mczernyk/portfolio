      ...
      <div>
        <div className="modal-section">
          <div className="modal-info">
            <h3 className="modal-title">Coffee Clicker
            </h3>
              <div className="subheading">
                Incremental game based on Cookie Clicker by Julien
                Thiennot
              </div>
              <ul>
                <li>
                  Core functionality built as first Checkpoint at
                  Fullstack Academy following initial week of classes.
                </li>
                <li>
                  Independently added custom CSS styling and design
                  elements to further develop Front End skills.
                </li>
              </ul>
          ...
          <div className="modal-date">
            <div>
              ...
              <div className="social-icons-modal">
                <a key='https://mczernyk.github.io/Checkpoint.DOM/'
