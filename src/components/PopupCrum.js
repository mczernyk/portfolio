        ...
        <div className="modal-section">
          <div className="modal-info">
            <h3 className="modal-title">Crum</h3>
              ...
              <ul>
                <li>
                  Allows users to drop and collect “Crums” - images with
                  attached messages - that are tied to location.
                </li>
                <li>
                  Crums can be dropped privately for a specific user or publically for all to see.
                </li>
                <li>
                  Crums are visible in Augmented Reality via mobile
                  camera or on map via icon.
                </li>
                <li>
                  Map view provides distance and directions to nearby Crums.
                </li>
                <li>
                  Users can comment on and collect Crums through screen
                  tap in AR view.
                </li>
                <li>
                  App provides different experience based on device capability. No-AR mode available to users with older phones.
                </li>
                <li>
                  Built with{' '}
          ...
          <div className="modal-date">
            <div>
              ...
              <div className="social-icons-modal">
                <a key='https://github.com/TeamKnown/Crum'
                ...
                <a key='https://www.youtube.com/watch?v=yui-dKm0ZwM&feature=youtu.be'
